...
class reportClass:
    def __init__(self, root):
        ...
        # Result Labels
        lbl_roll = Label(self.root, text="Roll No", font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        lbl_roll.place(x=150, y=230, width=150, height=50)

        lbl_name = Label(self.root, text="Name", font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        lbl_name.place(x=300, y=230, width=150, height=50)

        lbl_course = Label(self.root, text="Course", font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        lbl_course.place(x=450, y=230, width=150, height=50)

        lbl_marks = Label(self.root, text="Marks Scored", font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        lbl_marks.place(x=600, y=230, width=150, height=50)

        lbl_full = Label(self.root, text="Total Marks", font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        lbl_full.place(x=750, y=230, width=150, height=50)

        lbl_per = Label(self.root, text="Percentage", font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        lbl_per.place(x=900, y=230, width=150, height=50)

        # Result Display Labels
        self.roll = Label(self.root, font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        self.roll.place(x=150, y=280, width=150, height=50)

        self.name = Label(self.root, font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        self.name.place(x=300, y=280, width=150, height=50)

        self.course = Label(self.root, font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        self.course.place(x=450, y=280, width=150, height=50)

        self.marks = Label(self.root, font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        self.marks.place(x=600, y=280, width=150, height=50)

        self.full = Label(self.root, font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
        self.full.place(x=750, y=280, width=150, height=50)

        self.per = Label(self.root, font=("goudy old style", 20, "bold"), bg="white", relief=GROOVE)
